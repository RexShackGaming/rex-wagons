...
Config.WagonShopLocations = {
    ...
    {   --blackwater
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(-877.52, -1359.46, 43.52, 13.86),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
    ...
    {   --strawberry
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(-1811.61, -557.70, 155.99, 277.53),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
    ...
    {   --dewberry
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(1210.27, -184.83, 101.33, 24.92),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
        blipname = 'Dewberry Wagons',
    ...
    {   --emerald ranch
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(1389.56, 318.96, 87.74, 203.33),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
        blipname = 'Emerald Ranch Wagons',
    ...
    {   --van horn
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(2958.09, 789.14, 51.40, 102.72),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
    ...
    {   --tumbleweed
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(-5536.83, -3055.49, -1.26, 210.53),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
    ...
    {   --rhodes
        ...
        npcmodel = 's_m_m_valdealer_01',
        npccoords = vec4(1431.72, -1308.99, 77.70, 107.77),
        scenario = 'WORLD_HUMAN_CLIPBOARD',
        showblip = true,
        blipscale = 0.2,
        blipsprite = 'blip_ambient_wagon',
        blipname = 'Rhodes Wagons',
        spawnpoint = vec4(1425.49, -1310.06, 77.59, 98.16),
    },
